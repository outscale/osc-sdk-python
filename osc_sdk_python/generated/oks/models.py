...
class AdmissionFlags(GeneratedModel):
    disable_admission_plugins: list[str] | None = Field(
        default=None, alias="disable_admission_plugins"
    )
    enable_admission_plugins: list[str] | None = Field(
        default=None, alias="enable_admission_plugins"
    )
    applied_admission_plugins: list[str] | None = Field(
        default=None, alias="applied_admission_plugins"
    )
...
class AutoMaintenances(GeneratedModel):
    minor_upgrade_maintenance: MaintenanceWindow = Field(
        alias="minor_upgrade_maintenance"
    )
    patch_upgrade_maintenance: MaintenanceWindow = Field(
        alias="patch_upgrade_maintenance"
    )
...
class AutoUpgradeMaintenance(GeneratedModel):
    ...
    week_day: Literal["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"] = Field(
        alias="weekDay"
    )
...
class Cluster(GeneratedModel):
    ...
    auto_maintenances: AutoMaintenances | None = Field(
        default=None, alias="auto_maintenances"
    )
    maintenance_window: Maintenance | None = Field(
        default=None, alias="maintenance_window"
    )
    control_planes: str = Field(alias="control_planes")
    expected_control_planes: str | None = Field(
        default=None, alias="expected_control_planes"
    )
    admin_whitelist: list[str] = Field(alias="admin_whitelist")
    statuses: Statuses = Field(alias="statuses")
    disable_api_termination: bool | None = Field(
        default=None, alias="disable_api_termination"
    )
...
class ClusterInput(GeneratedModel):
    ...
    admission_flags: AdmissionFlagsInput | None = Field(
        default=None, alias="admission_flags"
    )
...
class Maintenance(GeneratedModel):
    ...
    week_day: Literal["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun", "string"] = (
        Field(alias="week_day")
    )
...
class MaintenanceWindow(GeneratedModel):
    ...
    week_day: (
        Literal["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun", "string"] | None
    ) = Field(default=None, alias="week_day")
    tz: str | None = Field(default=None, alias="tz")
...
class OpenIdConnectConfig(GeneratedModel):
    ...
    required_claim: dict[str, str | bool | int | float] | None = Field(
        default=None, alias="required-claim"
    )
...
class Snapshot(GeneratedModel):
    ...
    description: str = Field(alias="Description")
    tags: list[ResourceTag] = Field(alias="Tags")
    permissions_to_create_volume: PermissionsOnResource = Field(
...
class UpgradeStrategy(GeneratedModel):
    ...
    auto_upgrade_maintenance: AutoUpgradeMaintenance = Field(
        alias="autoUpgradeMaintenance"
    )
