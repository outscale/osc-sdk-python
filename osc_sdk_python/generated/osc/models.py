...
class AcceptNetPeeringResponse(GeneratedModel):
    ...
    response_context: ResponseContext | None = Field(
        default=None, alias="ResponseContext"
    )
...
class AccessKey(GeneratedModel):
    ...
    last_modification_date: datetime.datetime | None = Field(
...
class Account(GeneratedModel):
    ...
    outscale_login_allowed: bool | None = Field(
        default=None, alias="OutscaleLoginAllowed"
    )
...
class ApiAccessPolicy(GeneratedModel):
    max_access_key_expiration_seconds: int | None = Field(
        default=None, alias="MaxAccessKeyExpirationSeconds"
    )
...
class BackendVmHealth(GeneratedModel):
    description: str | None = Field(default=None, alias="Description")
    state: Literal["InService", "OutOfService", "Unknown"] | None = Field(
...
class BsuCreated(GeneratedModel):
    ...
    link_date: datetime.datetime = Field(alias="LinkDate")
...
class CO2EmissionEntry(GeneratedModel):
    account_id: str | None = Field(default=None, alias="AccountId")
    category_distribution: list[CO2CategoryDistribution] | None = Field(
        default=None, alias="CategoryDistribution"
    )
    factor_distribution: list[CO2FactorDistribution] | None = Field(
        default=None, alias="FactorDistribution"
    )
...
class CreateAccessKeyRequest(GeneratedModel):
    dry_run: bool | None = Field(default=None, alias="DryRun")
    expiration_date: datetime.datetime | str | None = Field(
        default=None, alias="ExpirationDate"
    )
    tag: str | None = Field(default=None, alias="Tag")
...
class CreateDhcpOptionsResponse(GeneratedModel):
    dhcp_options_set: DhcpOptionsSet | None = Field(
        default=None, alias="DhcpOptionsSet"
    )
    response_context: ResponseContext | None = Field(
        default=None, alias="ResponseContext"
    )
...
class CreateDirectLinkInterfaceResponse(GeneratedModel):
    direct_link_interface: DirectLinkInterfaces | None = Field(
        default=None, alias="DirectLinkInterface"
    )
    response_context: ResponseContext | None = Field(
        default=None, alias="ResponseContext"
    )
...
class CreateImageExportTaskResponse(GeneratedModel):
    image_export_task: ImageExportTask | None = Field(
        default=None, alias="ImageExportTask"
    )
    response_context: ResponseContext | None = Field(
        default=None, alias="ResponseContext"
    )
...
class CreateImageRequest(GeneratedModel):
    ...
    block_device_mappings: list[BlockDeviceMappingImage] | None = Field(
...
class CreateInternetServiceResponse(GeneratedModel):
    internet_service: InternetService | None = Field(
        default=None, alias="InternetService"
    )
    response_context: ResponseContext | None = Field(
        default=None, alias="ResponseContext"
    )
...
class CreateLoadBalancerPolicyRequest(GeneratedModel):
    cookie_expiration_period: int | None = Field(
...
class CreateNetAccessPointResponse(GeneratedModel):
    net_access_point: NetAccessPoint | None = Field(
        default=None, alias="NetAccessPoint"
    )
    response_context: ResponseContext | None = Field(
        default=None, alias="ResponseContext"
    )
...
class CreateSecurityGroupRuleRequest(GeneratedModel):
    ...
    security_group_account_id_to_link: str | None = Field(
        default=None, alias="SecurityGroupAccountIdToLink"
    )
    security_group_id: str = Field(alias="SecurityGroupId")
    security_group_name_to_link: str | None = Field(
        default=None, alias="SecurityGroupNameToLink"
    )
...
class CreateServerCertificateResponse(GeneratedModel):
    ...
    server_certificate: ServerCertificate | None = Field(
        default=None, alias="ServerCertificate"
    )
...
class CreateSnapshotExportTaskResponse(GeneratedModel):
    ...
    snapshot_export_task: SnapshotExportTask | None = Field(
        default=None, alias="SnapshotExportTask"
    )
...
class CreateVmGroupRequest(GeneratedModel):
    description: str | None = Field(default=None, alias="Description")
    dry_run: bool | None = Field(default=None, alias="DryRun")
    positioning_strategy: Literal["attract", "no-strategy", "repulse"] | None = Field(
        default=None, alias="PositioningStrategy"
    )
...
class CreateVmTemplateRequest(GeneratedModel):
    ...
    cpu_performance: Literal["medium", "high", "highest"] | None = Field(
        default=None, alias="CpuPerformance"
    )
    description: str | None = Field(default=None, alias="Description")
    dry_run: bool | None = Field(default=None, alias="DryRun")
    image_id: str = Field(alias="ImageId")
...
class CreateVmsRequest(GeneratedModel):
    actions_on_next_boot: ActionsOnNextBoot | None = Field(
        default=None, alias="ActionsOnNextBoot"
    )
    block_device_mappings: list[BlockDeviceMappingVmCreation] | None = Field(
        default=None, alias="BlockDeviceMappings"
    )
    ...
    nested_virtualization: bool | None = Field(
        default=None, alias="NestedVirtualization"
    )
    nics: list[NicForVmCreation] | None = Field(default=None, alias="Nics")
    performance: Literal["medium", "high", "highest"] | None = Field(
    ...
    security_group_ids: list[str] | None = Field(default=None, alias="SecurityGroupIds")
    security_groups: list[str] | None = Field(default=None, alias="SecurityGroups")
    shutdown_behavior_configuration: ShutdownBehaviorConfiguration | None = Field(
        default=None, alias="ShutdownBehaviorConfiguration"
    )
    ...
    vm_initiated_shutdown_behavior: str | None = Field(
        default=None, alias="VmInitiatedShutdownBehavior"
    )
...
class DeleteSecurityGroupRuleRequest(GeneratedModel):
    ...
    ip_range: str | None = Field(default=None, alias="IpRange")
    rules: list[SecurityGroupRule] | None = Field(default=None, alias="Rules")
    security_group_account_id_to_unlink: str | None = Field(
        default=None, alias="SecurityGroupAccountIdToUnlink"
    )
    security_group_id: str = Field(alias="SecurityGroupId")
    security_group_name_to_unlink: str | None = Field(
        default=None, alias="SecurityGroupNameToUnlink"
    )
    to_port_range: int | None = Field(default=None, alias="ToPortRange")
...
class DirectLinkInterfaces(GeneratedModel):
    ...
    client_private_ip: str | None = Field(default=None, alias="ClientPrivateIp")
    direct_link_id: str | None = Field(default=None, alias="DirectLinkId")
    direct_link_interface_id: str | None = Field(
        default=None, alias="DirectLinkInterfaceId"
    )
    direct_link_interface_name: str | None = Field(
        default=None, alias="DirectLinkInterfaceName"
    )
...
class FiltersApiAccessRule(GeneratedModel):
    api_access_rule_ids: list[str] | None = Field(
        default=None, alias="ApiAccessRuleIds"
    )
    ca_ids: list[str] | None = Field(default=None, alias="CaIds")
    cns: list[str] | None = Field(default=None, alias="Cns")
...
class FiltersApiLog(GeneratedModel):
    ...
    query_date_after: datetime.datetime | str | None = Field(
        default=None, alias="QueryDateAfter"
    )
    query_date_before: datetime.datetime | str | None = Field(
        default=None, alias="QueryDateBefore"
    )
    ...
    response_status_codes: list[int] | None = Field(
        default=None, alias="ResponseStatusCodes"
    )
...
class FiltersDedicatedGroup(GeneratedModel):
    ...
    dedicated_group_ids: list[str] | None = Field(
        default=None, alias="DedicatedGroupIds"
    )
...
class FiltersDhcpOptions(GeneratedModel):
    default: bool | None = Field(default=None, alias="Default")
    dhcp_options_set_ids: list[str] | None = Field(
        default=None, alias="DhcpOptionsSetIds"
    )
    domain_name_servers: list[str] | None = Field(
        default=None, alias="DomainNameServers"
    )
...
class FiltersDirectLinkInterface(GeneratedModel):
    direct_link_ids: list[str] | None = Field(default=None, alias="DirectLinkIds")
    direct_link_interface_ids: list[str] | None = Field(
        default=None, alias="DirectLinkInterfaceIds"
    )
...
class FiltersImage(GeneratedModel):
    ...
    block_device_mapping_delete_on_vm_deletion: bool | None = Field(
        default=None, alias="BlockDeviceMappingDeleteOnVmDeletion"
    )
    block_device_mapping_device_names: list[str] | None = Field(
        default=None, alias="BlockDeviceMappingDeviceNames"
    )
    block_device_mapping_snapshot_ids: list[str] | None = Field(
        default=None, alias="BlockDeviceMappingSnapshotIds"
    )
    block_device_mapping_volume_sizes: list[int] | None = Field(
        default=None, alias="BlockDeviceMappingVolumeSizes"
    )
    block_device_mapping_volume_types: list[VolumeType] | None = Field(
        default=None, alias="BlockDeviceMappingVolumeTypes"
    )
    boot_modes: list[BootMode] | None = Field(default=None, alias="BootModes")
    descriptions: list[str] | None = Field(default=None, alias="Descriptions")
    ...
    permissions_to_launch_account_ids: list[str] | None = Field(
        default=None, alias="PermissionsToLaunchAccountIds"
    )
    permissions_to_launch_global_permission: bool | None = Field(
        default=None, alias="PermissionsToLaunchGlobalPermission"
    )
    ...
    tags: list[str] | None = Field(default=None, alias="Tags")
    tpm_mandatory: bool | None = Field(default=None, alias="TpmMandatory")
    virtualization_types: list[str] | None = Field(
        default=None, alias="VirtualizationTypes"
    )


class FiltersInternetService(GeneratedModel):
    internet_service_ids: list[str] | None = Field(
        default=None, alias="InternetServiceIds"
    )
...
class FiltersKeypair(GeneratedModel):
    keypair_fingerprints: list[str] | None = Field(
        default=None, alias="KeypairFingerprints"
    )
...
class FiltersListenerRule(GeneratedModel):
    listener_rule_names: list[str] | None = Field(
        default=None, alias="ListenerRuleNames"
    )


class FiltersLoadBalancer(GeneratedModel):
    load_balancer_names: list[str] | None = Field(
...
class FiltersNetAccessPoint(GeneratedModel):
    net_access_point_ids: list[str] | None = Field(
        default=None, alias="NetAccessPointIds"
    )
    net_ids: list[str] | None = Field(default=None, alias="NetIds")
...
class FiltersNetPeering(GeneratedModel):
    accepter_net_account_ids: list[str] | None = Field(
        default=None, alias="AccepterNetAccountIds"
    )
    accepter_net_ip_ranges: list[str] | None = Field(
        default=None, alias="AccepterNetIpRanges"
    )
    accepter_net_net_ids: list[str] | None = Field(
        default=None, alias="AccepterNetNetIds"
    )
    expiration_dates: list[datetime.datetime] | None = Field(
        default=None, alias="ExpirationDates"
    )
    net_peering_ids: list[str] | None = Field(default=None, alias="NetPeeringIds")
    source_net_account_ids: list[str] | None = Field(
        default=None, alias="SourceNetAccountIds"
    )
    source_net_ip_ranges: list[str] | None = Field(
        default=None, alias="SourceNetIpRanges"
    )
...
class FiltersNic(GeneratedModel):
    ...
    link_nic_delete_on_vm_deletion: bool | None = Field(
        default=None, alias="LinkNicDeleteOnVmDeletion"
    )
    link_nic_device_numbers: list[int] | None = Field(
        default=None, alias="LinkNicDeviceNumbers"
    )
    link_nic_link_nic_ids: list[str] | None = Field(
        default=None, alias="LinkNicLinkNicIds"
    )
    link_nic_states: list[str] | None = Field(default=None, alias="LinkNicStates")
    link_nic_vm_account_ids: list[str] | None = Field(
        default=None, alias="LinkNicVmAccountIds"
    )
    link_nic_vm_ids: list[str] | None = Field(default=None, alias="LinkNicVmIds")
    link_public_ip_account_ids: list[str] | None = Field(
        default=None, alias="LinkPublicIpAccountIds"
    )
    link_public_ip_link_public_ip_ids: list[str] | None = Field(
        default=None, alias="LinkPublicIpLinkPublicIpIds"
    )
    link_public_ip_public_dns_names: list[str] | None = Field(
        default=None, alias="LinkPublicIpPublicDnsNames"
    )
    link_public_ip_public_ip_ids: list[str] | None = Field(
        default=None, alias="LinkPublicIpPublicIpIds"
    )
    link_public_ip_public_ips: list[str] | None = Field(
        default=None, alias="LinkPublicIpPublicIps"
    )
    ...
    private_ips_link_public_ip_account_ids: list[str] | None = Field(
        default=None, alias="PrivateIpsLinkPublicIpAccountIds"
    )
    private_ips_link_public_ip_public_ips: list[str] | None = Field(
        default=None, alias="PrivateIpsLinkPublicIpPublicIps"
    )
    private_ips_primary_ip: bool | None = Field(
        default=None, alias="PrivateIpsPrimaryIp"
    )
    private_ips_private_ips: list[str] | None = Field(
        default=None, alias="PrivateIpsPrivateIps"
    )
    security_group_ids: list[str] | None = Field(default=None, alias="SecurityGroupIds")
    security_group_names: list[str] | None = Field(
        default=None, alias="SecurityGroupNames"
    )
    states: list[str] | None = Field(default=None, alias="States")
    subnet_ids: list[str] | None = Field(default=None, alias="SubnetIds")
    subregion_names: list[str] | None = Field(default=None, alias="SubregionNames")
...
class FiltersQuota(GeneratedModel):
    ...
    short_descriptions: list[str] | None = Field(
        default=None, alias="ShortDescriptions"
    )
...
class FiltersRouteTable(GeneratedModel):
    link_route_table_ids: list[str] | None = Field(
        default=None, alias="LinkRouteTableIds"
    )
    link_route_table_link_route_table_ids: list[str] | None = Field(
        default=None, alias="LinkRouteTableLinkRouteTableIds"
    )
    ...
    net_ids: list[str] | None = Field(default=None, alias="NetIds")
    route_creation_methods: list[str] | None = Field(
        default=None, alias="RouteCreationMethods"
    )
    route_destination_ip_ranges: list[str] | None = Field(
        default=None, alias="RouteDestinationIpRanges"
    )
    route_destination_service_ids: list[str] | None = Field(
        default=None, alias="RouteDestinationServiceIds"
    )
    route_gateway_ids: list[str] | None = Field(default=None, alias="RouteGatewayIds")
    route_nat_service_ids: list[str] | None = Field(
        default=None, alias="RouteNatServiceIds"
    )
    route_net_peering_ids: list[str] | None = Field(
        default=None, alias="RouteNetPeeringIds"
    )
...
class FiltersSecurityGroup(GeneratedModel):
    descriptions: list[str] | None = Field(default=None, alias="Descriptions")
    inbound_rule_account_ids: list[str] | None = Field(
        default=None, alias="InboundRuleAccountIds"
    )
    inbound_rule_from_port_ranges: list[int] | None = Field(
        default=None, alias="InboundRuleFromPortRanges"
    )
    inbound_rule_ip_ranges: list[str] | None = Field(
        default=None, alias="InboundRuleIpRanges"
    )
    inbound_rule_protocols: list[str] | None = Field(
        default=None, alias="InboundRuleProtocols"
    )
    inbound_rule_security_group_ids: list[str] | None = Field(
        default=None, alias="InboundRuleSecurityGroupIds"
    )
    inbound_rule_security_group_names: list[str] | None = Field(
        default=None, alias="InboundRuleSecurityGroupNames"
    )
    inbound_rule_to_port_ranges: list[int] | None = Field(
        default=None, alias="InboundRuleToPortRanges"
    )
    net_ids: list[str] | None = Field(default=None, alias="NetIds")
    outbound_rule_account_ids: list[str] | None = Field(
        default=None, alias="OutboundRuleAccountIds"
    )
    outbound_rule_from_port_ranges: list[int] | None = Field(
        default=None, alias="OutboundRuleFromPortRanges"
    )
    outbound_rule_ip_ranges: list[str] | None = Field(
        default=None, alias="OutboundRuleIpRanges"
    )
    outbound_rule_protocols: list[str] | None = Field(
        default=None, alias="OutboundRuleProtocols"
    )
    outbound_rule_security_group_ids: list[str] | None = Field(
        default=None, alias="OutboundRuleSecurityGroupIds"
    )
    outbound_rule_security_group_names: list[str] | None = Field(
        default=None, alias="OutboundRuleSecurityGroupNames"
    )
    outbound_rule_to_port_ranges: list[int] | None = Field(
        default=None, alias="OutboundRuleToPortRanges"
    )
    security_group_ids: list[str] | None = Field(default=None, alias="SecurityGroupIds")
    security_group_names: list[str] | None = Field(
        default=None, alias="SecurityGroupNames"
...
class FiltersSnapshot(GeneratedModel):
    ...
    client_tokens: list[str] | None = Field(default=None, alias="ClientTokens")
    descriptions: list[str] | None = Field(default=None, alias="Descriptions")
    from_creation_date: datetime.datetime | None = Field(
        default=None, alias="FromCreationDate"
    )
    permissions_to_create_volume_account_ids: list[str] | None = Field(
        default=None, alias="PermissionsToCreateVolumeAccountIds"
    )
    permissions_to_create_volume_global_permission: bool | None = Field(
        default=None, alias="PermissionsToCreateVolumeGlobalPermission"
    )
    ...
    tag_values: list[str] | None = Field(default=None, alias="TagValues")
    tags: list[str] | None = Field(default=None, alias="Tags")
    to_creation_date: datetime.datetime | None = Field(
        default=None, alias="ToCreationDate"
    )
    volume_ids: list[str] | None = Field(default=None, alias="VolumeIds")
...
class FiltersSubnet(GeneratedModel):
    available_ips_counts: list[int] | None = Field(
        default=None, alias="AvailableIpsCounts"
    )
    ip_ranges: list[str] | None = Field(default=None, alias="IpRanges")
    net_ids: list[str] | None = Field(default=None, alias="NetIds")
    states: list[str] | None = Field(default=None, alias="States")
...
class FiltersVirtualGateway(GeneratedModel):
    ...
    tag_values: list[str] | None = Field(default=None, alias="TagValues")
    tags: list[str] | None = Field(default=None, alias="Tags")
    virtual_gateway_ids: list[str] | None = Field(
        default=None, alias="VirtualGatewayIds"
    )
...
class FiltersVm(GeneratedModel):
    ...
    block_device_mapping_link_dates: list[str | datetime.datetime] | None = Field(
        default=None, alias="BlockDeviceMappingLinkDates"
    )
    block_device_mapping_states: list[str] | None = Field(
        default=None, alias="BlockDeviceMappingStates"
    )
    block_device_mapping_volume_ids: list[str] | None = Field(
        default=None, alias="BlockDeviceMappingVolumeIds"
    )
    boot_modes: list[BootMode] | None = Field(default=None, alias="BootModes")
    client_tokens: list[str] | None = Field(default=None, alias="ClientTokens")
    creation_dates: list[str | datetime.datetime] | None = Field(
        default=None, alias="CreationDates"
    )
    image_ids: list[str] | None = Field(default=None, alias="ImageIds")
    is_source_dest_checked: bool | None = Field(
        default=None, alias="IsSourceDestChecked"
    )
    keypair_names: list[str] | None = Field(default=None, alias="KeypairNames")
    ...
    nic_is_source_dest_checked: bool | None = Field(
        default=None, alias="NicIsSourceDestChecked"
    )
    nic_link_nic_delete_on_vm_deletion: bool | None = Field(
        default=None, alias="NicLinkNicDeleteOnVmDeletion"
    )
    nic_link_nic_device_numbers: list[int] | None = Field(
        default=None, alias="NicLinkNicDeviceNumbers"
    )
    nic_link_nic_link_nic_dates: list[str | datetime.datetime] | None = Field(
        default=None, alias="NicLinkNicLinkNicDates"
    )
    nic_link_nic_link_nic_ids: list[str] | None = Field(
        default=None, alias="NicLinkNicLinkNicIds"
    )
    nic_link_nic_states: list[str] | None = Field(
        default=None, alias="NicLinkNicStates"
    )
    nic_link_nic_vm_account_ids: list[str] | None = Field(
        default=None, alias="NicLinkNicVmAccountIds"
    )
    nic_link_nic_vm_ids: list[str] | None = Field(default=None, alias="NicLinkNicVmIds")
    nic_link_public_ip_account_ids: list[str] | None = Field(
        default=None, alias="NicLinkPublicIpAccountIds"
    )
    nic_link_public_ip_link_public_ip_ids: list[str] | None = Field(
        default=None, alias="NicLinkPublicIpLinkPublicIpIds"
    )
    nic_link_public_ip_public_ip_ids: list[str] | None = Field(
        default=None, alias="NicLinkPublicIpPublicIpIds"
    )
    nic_link_public_ip_public_ips: list[str] | None = Field(
        default=None, alias="NicLinkPublicIpPublicIps"
    )
    ...
    nic_private_ips_link_public_ip_account_ids: list[str] | None = Field(
        default=None, alias="NicPrivateIpsLinkPublicIpAccountIds"
    )
    nic_private_ips_link_public_ip_ids: list[str] | None = Field(
        default=None, alias="NicPrivateIpsLinkPublicIpIds"
    )
    nic_private_ips_primary_ip: bool | None = Field(
        default=None, alias="NicPrivateIpsPrimaryIp"
    )
    nic_private_ips_private_ips: list[str] | None = Field(
        default=None, alias="NicPrivateIpsPrivateIps"
    )
    nic_security_group_ids: list[str] | None = Field(
        default=None, alias="NicSecurityGroupIds"
    )
    nic_security_group_names: list[str] | None = Field(
        default=None, alias="NicSecurityGroupNames"
    )
    ...
    nic_subregion_names: list[str] | None = Field(
        default=None, alias="NicSubregionNames"
    )
    ...
    state_reason_messages: list[str] | None = Field(
        default=None, alias="StateReasonMessages"
    )
    ...
    tpm_enabled: bool | None = Field(default=None, alias="TpmEnabled")
    vm_ids: list[str] | None = Field(default=None, alias="VmIds")
    vm_security_group_ids: list[str] | None = Field(
        default=None, alias="VmSecurityGroupIds"
    )
    vm_security_group_names: list[str] | None = Field(
        default=None, alias="VmSecurityGroupNames"
    )
...
class FiltersVmsState(GeneratedModel):
    maintenance_event_codes: list[str] | None = Field(
        default=None, alias="MaintenanceEventCodes"
    )
    maintenance_event_descriptions: list[str] | None = Field(
        default=None, alias="MaintenanceEventDescriptions"
    )
    maintenance_events_not_after: list[str | datetime.datetime] | None = Field(
        default=None, alias="MaintenanceEventsNotAfter"
    )
    maintenance_events_not_before: list[str | datetime.datetime] | None = Field(
        default=None, alias="MaintenanceEventsNotBefore"
    )
    subregion_names: list[str] | None = Field(default=None, alias="SubregionNames")
    vm_ids: list[str] | None = Field(default=None, alias="VmIds")
...
class FiltersVmsStopHistory(GeneratedModel):
    state_reasons: list[str] | None = Field(default=None, alias="StateReasons")
    stop_date_after: str | datetime.datetime | None = Field(
        default=None, alias="StopDateAfter"
    )
    stop_date_before: str | datetime.datetime | None = Field(
        default=None, alias="StopDateBefore"
    )
    vm_ids: list[str] | None = Field(default=None, alias="VmIds")
...
class FiltersVolume(GeneratedModel):
    client_tokens: list[str] | None = Field(default=None, alias="ClientTokens")
    creation_dates: list[datetime.datetime] | None = Field(
        default=None, alias="CreationDates"
    )
    link_volume_delete_on_vm_deletion: bool | None = Field(
        default=None, alias="LinkVolumeDeleteOnVmDeletion"
    )
    link_volume_device_names: list[str] | None = Field(
        default=None, alias="LinkVolumeDeviceNames"
    )
    link_volume_link_dates: list[datetime.datetime] | None = Field(
        default=None, alias="LinkVolumeLinkDates"
    )
    link_volume_link_states: list[str] | None = Field(
        default=None, alias="LinkVolumeLinkStates"
    )
...
class FlexibleGpu(GeneratedModel):
    ...
    model_name: str = Field(alias="ModelName")
    state: Literal["allocated", "attaching", "attached", "detaching"] = Field(
        alias="State"
    )
    subregion_name: str = Field(alias="SubregionName")
    tags: list[Tag] | None = Field(default=None, alias="Tags")
...
class Image(GeneratedModel):
    ...
    permissions_to_launch: PermissionsOnResource | None = Field(
        default=None, alias="PermissionsToLaunch"
    )
    product_codes: list[str] | None = Field(default=None, alias="ProductCodes")
    root_device_name: str | None = Field(default=None, alias="RootDeviceName")
...
class LinkNic(GeneratedModel):
    ...
    state: Literal["attaching", "attached", "detaching", "detached"] = Field(
        alias="State"
    )
...
class LinkPrivateIpsRequest(GeneratedModel):
    ...
    nic_id: str = Field(alias="NicId")
    private_ips: list[str] | None = Field(default=None, alias="PrivateIps")
    secondary_private_ip_count: int | None = Field(
        default=None, alias="SecondaryPrivateIpCount"
    )
...
class LinkVirtualGatewayResponse(GeneratedModel):
    net_to_virtual_gateway_link: NetToVirtualGatewayLink | None = Field(
        default=None, alias="NetToVirtualGatewayLink"
    )
    response_context: ResponseContext | None = Field(
        default=None, alias="ResponseContext"
    )
...
class LinkedVolume(GeneratedModel):
    delete_on_vm_deletion: bool = Field(alias="DeleteOnVmDeletion")
    device_name: str = Field(alias="DeviceName")
    state: Literal["attaching", "detaching", "attached", "detached"] = Field(
        alias="State"
    )
    vm_id: str = Field(alias="VmId")
    volume_id: str = Field(alias="VolumeId")
...
class LoadBalancer(GeneratedModel):
    ...
    application_sticky_cookie_policies: list[ApplicationStickyCookiePolicy] = Field(
        alias="ApplicationStickyCookiePolicies"
    )
    ...
    load_balancer_name: str = Field(alias="LoadBalancerName")
    load_balancer_sticky_cookie_policies: list[LoadBalancerStickyCookiePolicy] = Field(
        alias="LoadBalancerStickyCookiePolicies"
    )
...
class Nic(GeneratedModel):
    ...
    state: Literal["available", "attaching", "in-use", "detaching"] = Field(
        alias="State"
    )
    subnet_id: str = Field(alias="SubnetId")
    subregion_name: str = Field(alias="SubregionName")
...
class NicLight(GeneratedModel):
    ...
    link_public_ip: LinkPublicIpLightForVm | None = Field(
        default=None, alias="LinkPublicIp"
    )
    mac_address: str = Field(alias="MacAddress")
    net_id: str = Field(alias="NetId")
    nic_id: str = Field(alias="NicId")
...
class Phase1Options(GeneratedModel):
    ...
    phase1_dh_group_numbers: list[int] | None = Field(
        default=None, alias="Phase1DhGroupNumbers"
    )
    phase1_encryption_algorithms: list[str] | None = Field(
        default=None, alias="Phase1EncryptionAlgorithms"
    )
    phase1_integrity_algorithms: list[str] | None = Field(
        default=None, alias="Phase1IntegrityAlgorithms"
    )
    phase1_lifetime_seconds: int | None = Field(
...
class Phase2Options(GeneratedModel):
    phase2_dh_group_numbers: list[int] | None = Field(
        default=None, alias="Phase2DhGroupNumbers"
    )
    phase2_encryption_algorithms: list[str] | None = Field(
        default=None, alias="Phase2EncryptionAlgorithms"
    )
    phase2_integrity_algorithms: list[str] | None = Field(
        default=None, alias="Phase2IntegrityAlgorithms"
    )
    phase2_lifetime_seconds: int | None = Field(
...
class Policy(GeneratedModel):
    ...
    orn: str | None = Field(default=None, alias="Orn")
    path: str | None = Field(default=None, alias="Path")
    policy_default_version_id: str | None = Field(
        default=None, alias="PolicyDefaultVersionId"
    )
    policy_id: str | None = Field(default=None, alias="PolicyId")
    policy_name: str | None = Field(default=None, alias="PolicyName")
...
class PolicyEntities(GeneratedModel):
    ...
    max_results_truncated: bool | None = Field(
        default=None, alias="MaxResultsTruncated"
    )
...
class ReadApiAccessPolicyResponse(GeneratedModel):
    api_access_policy: ApiAccessPolicy | None = Field(
        default=None, alias="ApiAccessPolicy"
    )
    response_context: ResponseContext | None = Field(
        default=None, alias="ResponseContext"
    )
...
class ReadApiAccessRulesResponse(GeneratedModel):
    api_access_rules: list[ApiAccessRule] | None = Field(
        default=None, alias="ApiAccessRules"
    )
    response_context: ResponseContext | None = Field(
        default=None, alias="ResponseContext"
    )
...
class ReadCO2EmissionAccountResponse(GeneratedModel):
    co2_emission_entries: list[CO2EmissionEntry] | None = Field(
        default=None, alias="CO2EmissionEntries"
    )
    response_context: ResponseContext | None = Field(
        default=None, alias="ResponseContext"
    )
...
class ReadClientGatewaysResponse(GeneratedModel):
    client_gateways: list[ClientGateway] | None = Field(
        default=None, alias="ClientGateways"
    )
    next_page_token: str | None = Field(default=None, alias="NextPageToken")
    response_context: ResponseContext | None = Field(
        default=None, alias="ResponseContext"
...
class ReadConsumptionAccountRequest(GeneratedModel):
    ...
    show_resource_details: bool | None = Field(
        default=None, alias="ShowResourceDetails"
    )
    to_date: str | datetime.datetime = Field(alias="ToDate")


class ReadConsumptionAccountResponse(GeneratedModel):
    consumption_entries: list[ConsumptionEntry] | None = Field(
        default=None, alias="ConsumptionEntries"
    )
...
class ReadDedicatedGroupsResponse(GeneratedModel):
    dedicated_groups: list[DedicatedGroup] | None = Field(
        default=None, alias="DedicatedGroups"
    )
    next_page_token: str | None = Field(default=None, alias="NextPageToken")
    response_context: ResponseContext | None = Field(
        default=None, alias="ResponseContext"
...
class ReadDhcpOptionsResponse(GeneratedModel):
    dhcp_options_sets: list[DhcpOptionsSet] | None = Field(
        default=None, alias="DhcpOptionsSets"
    )
    next_page_token: str | None = Field(default=None, alias="NextPageToken")
    response_context: ResponseContext | None = Field(
        default=None, alias="ResponseContext"
...
class ReadDirectLinkInterfacesResponse(GeneratedModel):
    direct_link_interfaces: list[DirectLinkInterfaces] | None = Field(
        default=None, alias="DirectLinkInterfaces"
    )
    next_page_token: str | None = Field(default=None, alias="NextPageToken")
    response_context: ResponseContext | None = Field(
        default=None, alias="ResponseContext"
...
class ReadEntitiesLinkedToPolicyRequest(GeneratedModel):
    entities_type: list[Literal["ACCOUNT", "USER", "GROUP"]] | None = Field(
        default=None, alias="EntitiesType"
    )
...
class ReadFlexibleGpuCatalogResponse(GeneratedModel):
    flexible_gpu_catalog: list[FlexibleGpuCatalog] | None = Field(
        default=None, alias="FlexibleGpuCatalog"
    )
    response_context: ResponseContext | None = Field(
        default=None, alias="ResponseContext"
    )
...
class ReadImageExportTasksResponse(GeneratedModel):
    image_export_tasks: list[ImageExportTask] | None = Field(
        default=None, alias="ImageExportTasks"
    )
    next_page_token: str | None = Field(default=None, alias="NextPageToken")
    response_context: ResponseContext | None = Field(
        default=None, alias="ResponseContext"
...
class ReadInternetServicesResponse(GeneratedModel):
    internet_services: list[InternetService] | None = Field(
        default=None, alias="InternetServices"
    )
    next_page_token: str | None = Field(default=None, alias="NextPageToken")
    response_context: ResponseContext | None = Field(
        default=None, alias="ResponseContext"
...
class ReadListenerRulesResponse(GeneratedModel):
    listener_rules: list[ListenerRule] | None = Field(
        default=None, alias="ListenerRules"
    )
    response_context: ResponseContext | None = Field(
        default=None, alias="ResponseContext"
    )
...
class ReadLoadBalancersResponse(GeneratedModel):
    load_balancers: list[LoadBalancer] | None = Field(
...
class ReadNetAccessPointsResponse(GeneratedModel):
    net_access_points: list[NetAccessPoint] | None = Field(
        default=None, alias="NetAccessPoints"
    )
    next_page_token: str | None = Field(default=None, alias="NextPageToken")
    response_context: ResponseContext | None = Field(
        default=None, alias="ResponseContext"
...
class ReadPolicyVersionsResponse(GeneratedModel):
    has_more_items: bool | None = Field(default=None, alias="HasMoreItems")
    max_results_limit: int | None = Field(default=None, alias="MaxResultsLimit")
    policy_versions: list[PolicyVersion] | None = Field(
        default=None, alias="PolicyVersions"
    )
    response_context: ResponseContext | None = Field(
        default=None, alias="ResponseContext"
    )
...
class ReadSecurityGroupsResponse(GeneratedModel):
    ...
    security_groups: list[SecurityGroup] | None = Field(
...
class ReadServerCertificatesResponse(GeneratedModel):
    ...
    server_certificates: list[ServerCertificate] | None = Field(
        default=None, alias="ServerCertificates"
    )
...
class ReadSnapshotExportTasksResponse(GeneratedModel):
    ...
    snapshot_export_tasks: list[SnapshotExportTask] | None = Field(
        default=None, alias="SnapshotExportTasks"
    )
...
class ReadUnitPriceResponse(GeneratedModel):
    ...
    unit_price_entry: UnitPriceEntry | None = Field(
        default=None, alias="UnitPriceEntry"
    )
...
class ReadVirtualGatewaysResponse(GeneratedModel):
    ...
    virtual_gateways: list[VirtualGateway] | None = Field(
        default=None, alias="VirtualGateways"
    )
...
class ReadVmsHealthResponse(GeneratedModel):
    backend_vm_health: list[BackendVmHealth] | None = Field(
        default=None, alias="BackendVmHealth"
    )
    response_context: ResponseContext | None = Field(
        default=None, alias="ResponseContext"
    )
...
class ReadVmsStopHistoryResponse(GeneratedModel):
    ...
    vms_stop_history: list[VmsStopHistory] | None = Field(
        default=None, alias="VmsStopHistory"
    )
...
class ReadVolumeUpdateTasksResponse(GeneratedModel):
    ...
    volume_update_tasks: list[VolumeUpdateTask] | None = Field(
        default=None, alias="VolumeUpdateTasks"
    )
...
class ReadVpnConnectionsResponse(GeneratedModel):
    ...
    vpn_connections: list[VpnConnection] | None = Field(
        default=None, alias="VpnConnections"
    )
...
class Route(GeneratedModel):
    ...
    destination_ip_range: str = Field(alias="DestinationIpRange")
    destination_service_id: str | None = Field(
        default=None, alias="DestinationServiceId"
    )
    gateway_id: str | None = Field(default=None, alias="GatewayId")
    nat_service_id: str | None = Field(default=None, alias="NatServiceId")
...
class RouteTable(GeneratedModel):
    ...
    net_id: str = Field(alias="NetId")
    route_propagating_virtual_gateways: list[RoutePropagatingVirtualGateway] = Field(
        alias="RoutePropagatingVirtualGateways"
    )
    route_table_id: str = Field(alias="RouteTableId")
...
SecureBootAction = Literal[
    "enable", "disable", "setup-mode", "none", "restore-factory-keys"
]
...
class SecurityGroupRule(GeneratedModel):
    ...
    ip_protocol: str | None = Field(default=None, alias="IpProtocol")
    ip_ranges: list[str] | None = Field(default=None, alias="IpRanges")
    security_group_rule_id: str | None = Field(
        default=None, alias="SecurityGroupRuleId"
    )
    security_groups_members: list[SecurityGroupsMember] | None = Field(
        default=None, alias="SecurityGroupsMembers"
    )
    service_ids: list[str] | None = Field(default=None, alias="ServiceIds")
    to_port_range: int | None = Field(default=None, alias="ToPortRange")
...
class ShutdownBehaviorConfiguration(GeneratedModel):
    guest_action: Literal["stop", "terminate"] | None = Field(
        default=None, alias="GuestAction"
    )
    host_action: Literal["restart", "stop"] | None = Field(
        default=None, alias="HostAction"
    )
...
class Snapshot(GeneratedModel):
    ...
    creation_date: datetime.datetime = Field(alias="CreationDate")
    description: str | None = Field(default=None, alias="Description")
    permissions_to_create_volume: PermissionsOnResource | None = Field(
        default=None, alias="PermissionsToCreateVolume"
    )
    progress: int | None = Field(default=None, alias="Progress")
    snapshot_id: str = Field(alias="SnapshotId")
    state: Literal["in-queue", "pending", "completed", "error", "deleting"] = Field(
        alias="State"
    )
    tags: list[ResourceTag] | None = Field(default=None, alias="Tags")
    volume_id: str = Field(alias="VolumeId")
...
class SnapshotExportTask(GeneratedModel):
    ...
    snapshot_id: str = Field(alias="SnapshotId")
    state: Literal["pending", "active", "completed", "cancelled", "failed"] = Field(
        alias="State"
    )
    tags: list[ResourceTag] = Field(alias="Tags")
...
class SourceSecurityGroup(GeneratedModel):
    security_group_account_id: str | None = Field(
        default=None, alias="SecurityGroupAccountId"
    )
    security_group_name: str | None = Field(default=None, alias="SecurityGroupName")
...
class UpdateAccessKeyRequest(GeneratedModel):
    access_key_id: str = Field(alias="AccessKeyId")
    clear_expiration_date: bool | None = Field(
        default=None, alias="ClearExpirationDate"
    )
...
class UpdateApiAccessPolicyRequest(GeneratedModel):
    dry_run: bool | None = Field(default=None, alias="DryRun")
    max_access_key_expiration_seconds: int = Field(
        alias="MaxAccessKeyExpirationSeconds"
    )
...
class UpdateImageRequest(GeneratedModel):
    ...
    dry_run: bool | None = Field(default=None, alias="DryRun")
    image_id: str = Field(alias="ImageId")
    permissions_to_launch: PermissionsOnResourceCreation | None = Field(
        default=None, alias="PermissionsToLaunch"
    )
    product_codes: list[str] | None = Field(default=None, alias="ProductCodes")
...
class UpdateNetAccessPointRequest(GeneratedModel):
    add_route_table_ids: list[str] | None = Field(
        default=None, alias="AddRouteTableIds"
    )
    dry_run: bool | None = Field(default=None, alias="DryRun")
    net_access_point_id: str = Field(alias="NetAccessPointId")
    remove_route_table_ids: list[str] | None = Field(
...
class UpdateSnapshotRequest(GeneratedModel):
    dry_run: bool | None = Field(default=None, alias="DryRun")
    permissions_to_create_volume: PermissionsOnResourceCreation = Field(
        alias="PermissionsToCreateVolume"
    )
    snapshot_id: str = Field(alias="SnapshotId")
...
class UpdateVmRequest(GeneratedModel):
    ...
    block_device_mappings: list[BlockDeviceMappingVmUpdate] | None = Field(
        default=None, alias="BlockDeviceMappings"
    )
    bsu_optimized: bool | None = Field(default=None, alias="BsuOptimized")
    deletion_protection: bool | None = Field(default=None, alias="DeletionProtection")
...
class VgwTelemetry(GeneratedModel):
    ...
    last_state_change_date: datetime.datetime | None = Field(
        default=None, alias="LastStateChangeDate"
    )
...
class VirtualGateway(GeneratedModel):
    connection_type: str = Field(alias="ConnectionType")
    net_to_virtual_gateway_links: list[NetToVirtualGatewayLink] = Field(
        alias="NetToVirtualGatewayLinks"
    )
    state: str = Field(alias="State")
    tags: list[ResourceTag] = Field(alias="Tags")
    virtual_gateway_id: str = Field(alias="VirtualGatewayId")
...
class Vm(GeneratedModel):
    ...
    architecture: str = Field(alias="Architecture")
    block_device_mappings: list[BlockDeviceMappingCreated] = Field(
...
class VmGroup(GeneratedModel):
    ...
    state: (
        Literal[
            "available", "deleted", "deleting", "pending", "scaling down", "scaling up"
        ]
        | None
...
class Volume(GeneratedModel):
    ...
    snapshot_id: str | None = Field(default=None, alias="SnapshotId")
    state: Literal["creating", "available", "in-use", "deleting", "error"] = Field(
        alias="State"
    )
    subregion_name: str = Field(alias="SubregionName")
    tags: list[ResourceTag] = Field(alias="Tags")
...
class VolumeUpdateTask(GeneratedModel):
    comment: str | None = Field(default=None, alias="Comment")
    completion_date: datetime.datetime | None = Field(
        default=None, alias="CompletionDate"
    )
    progress: int | None = Field(default=None, alias="Progress")
...
class VpnConnection(GeneratedModel):
    client_gateway_configuration: str | None = Field(
        default=None, alias="ClientGatewayConfiguration"
    )
    client_gateway_id: str = Field(alias="ClientGatewayId")
    connection_type: str = Field(alias="ConnectionType")
...
class VpnOptions(GeneratedModel):
    ...
    tunnel_inside_ip_range: str | None = Field(
        default=None, alias="TunnelInsideIpRange"
    )
