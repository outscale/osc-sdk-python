...
class TestEimUser(unittest.TestCase):
    def test_eim_user_lifecycle(self):
        ...
        try:
            ...
            if user_id:
                log_step("Deleting EIM user {}".format(user_name))
